...
function check_is_function(func) {
  if (!(func instanceof Function)) {
    throw {name :'TypeError', message: "generator must be a function"};
  }
}
...
Context.prototype.getGenerator = function(generator) {
